...
/**
 *  Implementation of the ArrayStack class where several STACK operations like pop, peek, push etc
 *  are performed on Integer array with the help of stack
 * 
...
public class Gautam_A06Q1 {
	...
	public static class ArrayStack<T> implements StackADT<T> {
		...
		/**
		 * Removes the element at the top of this stack and returns a reference
		 * to it.
		 * 
		...
		/**
		 * Returns a reference to the element at the top of this stack. The
